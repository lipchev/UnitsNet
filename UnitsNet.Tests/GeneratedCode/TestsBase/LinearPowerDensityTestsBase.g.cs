...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            Assert.Throws<ArgumentException>(() => new LinearPowerDensity(1, UnitSystem.SI));
            Assert.Throws<ArgumentException>(() => new LinearPowerDensity(1, UnitSystem.CGS));
            Assert.Throws<ArgumentException>(() => new LinearPowerDensity(1, UnitSystem.BI));
            Assert.Throws<ArgumentException>(() => new LinearPowerDensity(1, UnitSystem.EE));
            Assert.Throws<ArgumentException>(() => new LinearPowerDensity(1, UnitSystem.USC));
            Assert.Throws<ArgumentException>(() => new LinearPowerDensity(1, UnitSystem.FPS));
            Assert.Throws<ArgumentException>(() => new LinearPowerDensity(1, UnitSystem.Astronomical));
        }

        [Fact]
        public void Ctor_WithNullUnitSystem_ThrowsArgumentNullException()
        {
            Assert.Throws<ArgumentNullException>(() => new LinearPowerDensity(1, null));
        }
        ...
        public void As_UnitSystem_ThrowsArgumentExceptionIfNotSupported()
        {
            ...
            Assert.Throws<ArgumentException>(() => wattpermeter.As(UnitSystem.SI));
            Assert.Throws<ArgumentException>(() => wattpermeter.As(UnitSystem.CGS));
            Assert.Throws<ArgumentException>(() => wattpermeter.As(UnitSystem.BI));
            Assert.Throws<ArgumentException>(() => wattpermeter.As(UnitSystem.EE));
            Assert.Throws<ArgumentException>(() => wattpermeter.As(UnitSystem.USC));
            Assert.Throws<ArgumentException>(() => wattpermeter.As(UnitSystem.FPS));
            Assert.Throws<ArgumentException>(() => wattpermeter.As(UnitSystem.Astronomical));
        }
        ...
        public void As_WithNullUnitSystem_ThrowsArgumentNullException()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => wattpermeter.As(null));
        }
        ...
        public void To_UnitSystem_ThrowsArgumentExceptionIfNotSupported()
        {
            ...
            Assert.Throws<ArgumentException>(() => wattpermeter.ToUnit(UnitSystem.SI));
            Assert.Throws<ArgumentException>(() => wattpermeter.ToUnit(UnitSystem.CGS));
            Assert.Throws<ArgumentException>(() => wattpermeter.ToUnit(UnitSystem.BI));
            Assert.Throws<ArgumentException>(() => wattpermeter.ToUnit(UnitSystem.EE));
            Assert.Throws<ArgumentException>(() => wattpermeter.ToUnit(UnitSystem.USC));
            Assert.Throws<ArgumentException>(() => wattpermeter.ToUnit(UnitSystem.FPS));
            Assert.Throws<ArgumentException>(() => wattpermeter.ToUnit(UnitSystem.Astronomical));
        }
        ...
        public void ToUnit_WithNullUnitSystem_ThrowsNullException()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => wattpermeter.ToUnit(null));
        }
