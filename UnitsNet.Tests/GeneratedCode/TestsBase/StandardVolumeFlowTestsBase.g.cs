...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            Assert.Throws<ArgumentException>(() => new StandardVolumeFlow(1, UnitSystem.SI));
            Assert.Throws<ArgumentException>(() => new StandardVolumeFlow(1, UnitSystem.CGS));
            Assert.Throws<ArgumentException>(() => new StandardVolumeFlow(1, UnitSystem.BI));
            Assert.Throws<ArgumentException>(() => new StandardVolumeFlow(1, UnitSystem.EE));
            Assert.Throws<ArgumentException>(() => new StandardVolumeFlow(1, UnitSystem.USC));
            Assert.Throws<ArgumentException>(() => new StandardVolumeFlow(1, UnitSystem.FPS));
            Assert.Throws<ArgumentException>(() => new StandardVolumeFlow(1, UnitSystem.Astronomical));
        }

        [Fact]
        public void Ctor_WithNullUnitSystem_ThrowsArgumentNullException()
        {
            Assert.Throws<ArgumentNullException>(() => new StandardVolumeFlow(1, null));
        }
        ...
        public void As_UnitSystem_ThrowsArgumentExceptionIfNotSupported()
        {
            ...
            Assert.Throws<ArgumentException>(() => standardcubicmeterpersecond.As(UnitSystem.SI));
            Assert.Throws<ArgumentException>(() => standardcubicmeterpersecond.As(UnitSystem.CGS));
            Assert.Throws<ArgumentException>(() => standardcubicmeterpersecond.As(UnitSystem.BI));
            Assert.Throws<ArgumentException>(() => standardcubicmeterpersecond.As(UnitSystem.EE));
            Assert.Throws<ArgumentException>(() => standardcubicmeterpersecond.As(UnitSystem.USC));
            Assert.Throws<ArgumentException>(() => standardcubicmeterpersecond.As(UnitSystem.FPS));
            Assert.Throws<ArgumentException>(() => standardcubicmeterpersecond.As(UnitSystem.Astronomical));
        }
        ...
        public void As_WithNullUnitSystem_ThrowsArgumentNullException()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => standardcubicmeterpersecond.As(null));
        }
        ...
        public void To_UnitSystem_ThrowsArgumentExceptionIfNotSupported()
        {
            ...
            Assert.Throws<ArgumentException>(() => standardcubicmeterpersecond.ToUnit(UnitSystem.SI));
            Assert.Throws<ArgumentException>(() => standardcubicmeterpersecond.ToUnit(UnitSystem.CGS));
            Assert.Throws<ArgumentException>(() => standardcubicmeterpersecond.ToUnit(UnitSystem.BI));
            Assert.Throws<ArgumentException>(() => standardcubicmeterpersecond.ToUnit(UnitSystem.EE));
            Assert.Throws<ArgumentException>(() => standardcubicmeterpersecond.ToUnit(UnitSystem.USC));
            Assert.Throws<ArgumentException>(() => standardcubicmeterpersecond.ToUnit(UnitSystem.FPS));
            Assert.Throws<ArgumentException>(() => standardcubicmeterpersecond.ToUnit(UnitSystem.Astronomical));
        }
        ...
        public void ToUnit_WithNullUnitSystem_ThrowsNullException()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => standardcubicmeterpersecond.ToUnit(null));
        }
