...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        public void Ctor_SIUnitSystem_ThrowsArgumentExceptionIfNotSupported()
        {
            ...
            {
                Assert.Throws<ArgumentException>(() => new Molality(value: 1, unitSystem: UnitSystem.SI));
            }
        }
        ...
        public void Parse()
        {
            try
            {
                ...
                Assert.Equal(1, parsed.MillimolesPerKilogram);
            ...
            try
            {
                ...
                Assert.Equal(1, parsed.MolesPerGram);
            ...
            try
            {
                ...
                Assert.Equal(1, parsed.MolesPerKilogram);
        ...
        {
            Molality moleperkilogram = Molality.FromMolesPerKilogram(1);
            Assert.Equal(1, Molality.FromMillimolesPerKilogram(moleperkilogram.MillimolesPerKilogram).MolesPerKilogram);
            Assert.Equal(1, Molality.FromMolesPerGram(moleperkilogram.MolesPerGram).MolesPerKilogram);
            Assert.Equal(1, Molality.FromMolesPerKilogram(moleperkilogram.MolesPerKilogram).MolesPerKilogram);
        }
        ...
        public void Equals_WithTolerance_IsImplemented()
        {
            ...
            Assert.True(v.Equals(Molality.FromMolesPerKilogram(1), Molality.FromMolesPerKilogram(0)));
            Assert.True(v.Equals(Molality.FromMolesPerKilogram(1), Molality.FromMolesPerKilogram(0.001m)));
            Assert.True(v.Equals(Molality.FromMolesPerKilogram(0.9999), Molality.FromMolesPerKilogram(0.001m)));
            Assert.False(v.Equals(Molality.FromMolesPerKilogram(0.99), Molality.FromMolesPerKilogram(0.001m)));
            Assert.False(v.Equals(Molality.Zero, Molality.FromMolesPerKilogram(0.001m)));
        }
        ...
        public void Equals_WithNegativeTolerance_ThrowsArgumentOutOfRangeException()
        {
            ...
            Assert.Throws<ArgumentOutOfRangeException>(() => v.Equals(Molality.FromMolesPerKilogram(1), negativeTolerance));
        }
