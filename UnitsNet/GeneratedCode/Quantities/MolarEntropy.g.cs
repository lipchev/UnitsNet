        ...
        IFormattable
    {
        ...
        private bool TryToUnit(MolarEntropyUnit unit, [NotNullWhen(true)] out MolarEntropy? converted)
        {
            ...
            MolarEntropy? convertedOrNull = (Unit, unit) switch
            {
                ...
                (MolarEntropyUnit.KilojoulePerMoleKelvin, MolarEntropyUnit.JoulePerMoleKelvin) => new MolarEntropy(_value * 1000, MolarEntropyUnit.JoulePerMoleKelvin),
                (MolarEntropyUnit.MegajoulePerMoleKelvin, MolarEntropyUnit.JoulePerMoleKelvin) => new MolarEntropy(_value * 1000000, MolarEntropyUnit.JoulePerMoleKelvin),

                // BaseUnit -> MolarEntropyUnit
                (MolarEntropyUnit.JoulePerMoleKelvin, MolarEntropyUnit.KilojoulePerMoleKelvin) => new MolarEntropy(_value / 1000, MolarEntropyUnit.KilojoulePerMoleKelvin),
                (MolarEntropyUnit.JoulePerMoleKelvin, MolarEntropyUnit.MegajoulePerMoleKelvin) => new MolarEntropy(_value / 1000000, MolarEntropyUnit.MegajoulePerMoleKelvin),
