...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        public QuantityValue As(ForceChangeRateUnit unit)
        {
            if (Unit == unit)
                return Value;
        ...
        private bool TryToUnit(ForceChangeRateUnit unit, [NotNullWhen(true)] out ForceChangeRate? converted)
        {
            ...
            ForceChangeRate? convertedOrNull = (Unit, unit) switch
            {
                ...
                (ForceChangeRateUnit.KilonewtonPerMinute, ForceChangeRateUnit.NewtonPerSecond) => new ForceChangeRate(_value * new QuantityValue(50, 3), ForceChangeRateUnit.NewtonPerSecond),
                ...
                (ForceChangeRateUnit.KilopoundForcePerMinute, ForceChangeRateUnit.NewtonPerSecond) => new ForceChangeRate(_value * new QuantityValue(8896443230521, 120000000000), ForceChangeRateUnit.NewtonPerSecond),
                (ForceChangeRateUnit.KilopoundForcePerSecond, ForceChangeRateUnit.NewtonPerSecond) => new ForceChangeRate(_value * new QuantityValue(8896443230521, 2000000000), ForceChangeRateUnit.NewtonPerSecond),
                ...
                (ForceChangeRateUnit.PoundForcePerMinute, ForceChangeRateUnit.NewtonPerSecond) => new ForceChangeRate(_value * new QuantityValue(8896443230521, 120000000000000), ForceChangeRateUnit.NewtonPerSecond),
                (ForceChangeRateUnit.PoundForcePerSecond, ForceChangeRateUnit.NewtonPerSecond) => new ForceChangeRate(_value * new QuantityValue(8896443230521, 2000000000000), ForceChangeRateUnit.NewtonPerSecond),
                ...
                (ForceChangeRateUnit.NewtonPerSecond, ForceChangeRateUnit.KilonewtonPerMinute) => new ForceChangeRate(_value * new QuantityValue(3, 50), ForceChangeRateUnit.KilonewtonPerMinute),
                ...
                (ForceChangeRateUnit.NewtonPerSecond, ForceChangeRateUnit.KilopoundForcePerMinute) => new ForceChangeRate(_value * new QuantityValue(120000000000, 8896443230521), ForceChangeRateUnit.KilopoundForcePerMinute),
                (ForceChangeRateUnit.NewtonPerSecond, ForceChangeRateUnit.KilopoundForcePerSecond) => new ForceChangeRate(_value * new QuantityValue(2000000000, 8896443230521), ForceChangeRateUnit.KilopoundForcePerSecond),
                ...
                (ForceChangeRateUnit.NewtonPerSecond, ForceChangeRateUnit.PoundForcePerMinute) => new ForceChangeRate(_value * new QuantityValue(120000000000000, 8896443230521), ForceChangeRateUnit.PoundForcePerMinute),
                (ForceChangeRateUnit.NewtonPerSecond, ForceChangeRateUnit.PoundForcePerSecond) => new ForceChangeRate(_value * new QuantityValue(2000000000000, 8896443230521), ForceChangeRateUnit.PoundForcePerSecond),
