...
namespace UnitsNet
{
    ...
    public partial struct Magnetization : IQuantity<MagnetizationUnit>, IEquatable<Magnetization>, IComparable, IComparable<Magnetization>, IConvertible, IFormattable
    {
        ...
        /// <exception cref="ArgumentNullException">The value of 'str' cannot be null. </exception>
        /// <exception cref="UnitsNetException">Error parsing string.</exception>
        public static MagnetizationUnit ParseUnit(string str, [CanBeNull] IFormatProvider provider)
        {
        ...
        {
            return QuantityFormatter.Format<MagnetizationUnit>(this, format, formatProvider);
        }
