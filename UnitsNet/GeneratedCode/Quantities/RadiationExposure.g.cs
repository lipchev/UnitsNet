...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        public QuantityValue As(RadiationExposureUnit unit)
        {
            if (Unit == unit)
                return Value;
        ...
        private bool TryToUnit(RadiationExposureUnit unit, [NotNullWhen(true)] out RadiationExposure? converted)
        {
            ...
            RadiationExposure? convertedOrNull = (Unit, unit) switch
            {
                ...
                (RadiationExposureUnit.Microroentgen, RadiationExposureUnit.CoulombPerKilogram) => new RadiationExposure(_value * new QuantityValue(129, 500000000000), RadiationExposureUnit.CoulombPerKilogram),
                ...
                (RadiationExposureUnit.Milliroentgen, RadiationExposureUnit.CoulombPerKilogram) => new RadiationExposure(_value * new QuantityValue(129, 500000000), RadiationExposureUnit.CoulombPerKilogram),
                ...
                (RadiationExposureUnit.Roentgen, RadiationExposureUnit.CoulombPerKilogram) => new RadiationExposure(_value * new QuantityValue(129, 500000), RadiationExposureUnit.CoulombPerKilogram),
                ...
                (RadiationExposureUnit.CoulombPerKilogram, RadiationExposureUnit.Microroentgen) => new RadiationExposure(_value * new QuantityValue(500000000000, 129), RadiationExposureUnit.Microroentgen),
                ...
                (RadiationExposureUnit.CoulombPerKilogram, RadiationExposureUnit.Milliroentgen) => new RadiationExposure(_value * new QuantityValue(500000000, 129), RadiationExposureUnit.Milliroentgen),
                ...
                (RadiationExposureUnit.CoulombPerKilogram, RadiationExposureUnit.Roentgen) => new RadiationExposure(_value * new QuantityValue(500000, 129), RadiationExposureUnit.Roentgen),
