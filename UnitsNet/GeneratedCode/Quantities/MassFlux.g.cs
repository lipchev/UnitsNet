...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        public QuantityValue As(MassFluxUnit unit)
        {
            if (Unit == unit)
                return Value;
        ...
        private bool TryToUnit(MassFluxUnit unit, [NotNullWhen(true)] out MassFlux? converted)
        {
            ...
            MassFlux? convertedOrNull = (Unit, unit) switch
            {
                ...
                (MassFluxUnit.GramPerHourPerSquareMillimeter, MassFluxUnit.KilogramPerSecondPerSquareMeter) => new MassFlux(_value * new QuantityValue(5, 18), MassFluxUnit.KilogramPerSecondPerSquareMeter),
                ...
                (MassFluxUnit.KilogramPerHourPerSquareCentimeter, MassFluxUnit.KilogramPerSecondPerSquareMeter) => new MassFlux(_value * new QuantityValue(25, 9), MassFluxUnit.KilogramPerSecondPerSquareMeter),
                ...
                (MassFluxUnit.KilogramPerHourPerSquareMillimeter, MassFluxUnit.KilogramPerSecondPerSquareMeter) => new MassFlux(_value * new QuantityValue(2500, 9), MassFluxUnit.KilogramPerSecondPerSquareMeter),
                ...
                (MassFluxUnit.KilogramPerSecondPerSquareMeter, MassFluxUnit.GramPerHourPerSquareMillimeter) => new MassFlux(_value * new QuantityValue(18, 5), MassFluxUnit.GramPerHourPerSquareMillimeter),
                ...
                (MassFluxUnit.KilogramPerSecondPerSquareMeter, MassFluxUnit.KilogramPerHourPerSquareCentimeter) => new MassFlux(_value * new QuantityValue(9, 25), MassFluxUnit.KilogramPerHourPerSquareCentimeter),
                ...
                (MassFluxUnit.KilogramPerSecondPerSquareMeter, MassFluxUnit.KilogramPerHourPerSquareMillimeter) => new MassFlux(_value * new QuantityValue(9, 2500), MassFluxUnit.KilogramPerHourPerSquareMillimeter),
