...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        public QuantityValue As(ElectricPotentialUnit unit)
        {
            if (Unit == unit)
                return Value;
