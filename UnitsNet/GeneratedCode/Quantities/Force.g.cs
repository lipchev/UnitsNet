        ...
        IFormattable
    {
        ...
        private bool TryToUnit(ForceUnit unit, [NotNullWhen(true)] out Force? converted)
        {
            ...
            Force? convertedOrNull = (Unit, unit) switch
            {
                ...
                (ForceUnit.KilogramForce, ForceUnit.Newton) => new Force(_value * new QuantityValue(196133, 20000), ForceUnit.Newton),
                (ForceUnit.Kilonewton, ForceUnit.Newton) => new Force(_value * 1000, ForceUnit.Newton),
                (ForceUnit.KiloPond, ForceUnit.Newton) => new Force(_value * new QuantityValue(196133, 20000), ForceUnit.Newton),
                (ForceUnit.KilopoundForce, ForceUnit.Newton) => new Force(_value * new QuantityValue(8896443230521, 2000000000), ForceUnit.Newton),
                ...
                (ForceUnit.OunceForce, ForceUnit.Newton) => new Force(_value * new QuantityValue(8896443230521, 32000000000000), ForceUnit.Newton),
                (ForceUnit.Poundal, ForceUnit.Newton) => new Force(_value * new QuantityValue(17281869297, 125000000000), ForceUnit.Newton),
                (ForceUnit.PoundForce, ForceUnit.Newton) => new Force(_value * new QuantityValue(8896443230521, 2000000000000), ForceUnit.Newton),
                (ForceUnit.ShortTonForce, ForceUnit.Newton) => new Force(_value * new QuantityValue(8896443230521, 1000000000), ForceUnit.Newton),
                (ForceUnit.TonneForce, ForceUnit.Newton) => new Force(_value * new QuantityValue(196133, 20), ForceUnit.Newton),
                ...
                (ForceUnit.Newton, ForceUnit.KilogramForce) => new Force(_value * new QuantityValue(20000, 196133), ForceUnit.KilogramForce),
                (ForceUnit.Newton, ForceUnit.Kilonewton) => new Force(_value / 1000, ForceUnit.Kilonewton),
                (ForceUnit.Newton, ForceUnit.KiloPond) => new Force(_value * new QuantityValue(20000, 196133), ForceUnit.KiloPond),
                (ForceUnit.Newton, ForceUnit.KilopoundForce) => new Force(_value * new QuantityValue(2000000000, 8896443230521), ForceUnit.KilopoundForce),
                ...
                (ForceUnit.Newton, ForceUnit.OunceForce) => new Force(_value * new QuantityValue(32000000000000, 8896443230521), ForceUnit.OunceForce),
                (ForceUnit.Newton, ForceUnit.Poundal) => new Force(_value * new QuantityValue(125000000000, 17281869297), ForceUnit.Poundal),
                (ForceUnit.Newton, ForceUnit.PoundForce) => new Force(_value * new QuantityValue(2000000000000, 8896443230521), ForceUnit.PoundForce),
                (ForceUnit.Newton, ForceUnit.ShortTonForce) => new Force(_value * new QuantityValue(1000000000, 8896443230521), ForceUnit.ShortTonForce),
                (ForceUnit.Newton, ForceUnit.TonneForce) => new Force(_value * new QuantityValue(20, 196133), ForceUnit.TonneForce),
