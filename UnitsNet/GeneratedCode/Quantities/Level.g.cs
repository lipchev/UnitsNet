...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        public Level(QuantityValue value, UnitSystem unitSystem)
        {
        ...
        /// </summary>
        public QuantityValue Decibels => As(LevelUnit.Decibel);

        /// <summary>
        ///     Gets a <see cref="double"/> value of this quantity converted into <see cref="LevelUnit.Neper"/>
        /// </summary>
        public QuantityValue Nepers => As(LevelUnit.Neper);
        ...
        public static Level operator +(Level left, Level right)
        {
            ...
            return new Level(10 * QuantityValue.FromDoubleRounded(Math.Log10(
        ...
        public QuantityValue As(LevelUnit unit)
        {
            if (Unit == unit)
                return Value;
        ...
        private bool TryToUnit(LevelUnit unit, [NotNullWhen(true)] out Level? converted)
        {
            ...
            {
                // LevelUnit -> BaseUnit
                (LevelUnit.Neper, LevelUnit.Decibel) => new Level(_value * new QuantityValue(500000000, 57564627), LevelUnit.Decibel),

                // BaseUnit -> LevelUnit
                (LevelUnit.Decibel, LevelUnit.Neper) => new Level(_value * new QuantityValue(57564627, 500000000), LevelUnit.Neper),
