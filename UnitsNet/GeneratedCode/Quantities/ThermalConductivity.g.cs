...
namespace UnitsNet
{
    ...
    public partial struct ThermalConductivity : IQuantity<ThermalConductivityUnit>, IEquatable<ThermalConductivity>, IComparable, IComparable<ThermalConductivity>, IConvertible, IFormattable
    {
        ...
        public ThermalConductivity(double value, UnitSystem unitSystem)
        {
            ...
            var defaultUnitInfo = unitSystem.GetDefaultUnitInfo(QuantityType) as UnitInfo<ThermalConductivityUnit>;
        ...
        /// <exception cref="ArgumentNullException">The value of 'str' cannot be null. </exception>
        /// <exception cref="UnitsNetException">Error parsing string.</exception>
        public static ThermalConductivityUnit ParseUnit(string str, [CanBeNull] IFormatProvider provider)
        {
        ...
        {
            return QuantityFormatter.Format<ThermalConductivityUnit>(this, format, formatProvider);
        }
