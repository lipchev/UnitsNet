        ...
        IFormattable
    {
        ...
        private bool TryToUnit(ThermalConductivityUnit unit, [NotNullWhen(true)] out ThermalConductivity? converted)
        {
            ...
            ThermalConductivity? convertedOrNull = (Unit, unit) switch
            {
                ...
                (ThermalConductivityUnit.BtuPerHourFootFahrenheit, ThermalConductivityUnit.WattPerMeterKelvin) => new ThermalConductivity(_value * new QuantityValue(52752792631, 30480000000), ThermalConductivityUnit.WattPerMeterKelvin),

                // BaseUnit -> ThermalConductivityUnit
                (ThermalConductivityUnit.WattPerMeterKelvin, ThermalConductivityUnit.BtuPerHourFootFahrenheit) => new ThermalConductivity(_value * new QuantityValue(30480000000, 52752792631), ThermalConductivityUnit.BtuPerHourFootFahrenheit),
