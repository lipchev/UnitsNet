...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        /// </summary>
        public QuantityValue MillimolesPerKilogram => As(MolalityUnit.MillimolePerKilogram);
        ...
        private bool TryToUnit(MolalityUnit unit, [NotNullWhen(true)] out Molality? converted)
        {
            ...
            Molality? convertedOrNull = (Unit, unit) switch
            {
                ...
                (MolalityUnit.MillimolePerKilogram, MolalityUnit.MolePerKilogram) => new Molality(_value / 1000, MolalityUnit.MolePerKilogram),
                (MolalityUnit.MolePerGram, MolalityUnit.MolePerKilogram) => new Molality(_value * 1000, MolalityUnit.MolePerKilogram),

                // BaseUnit -> MolalityUnit
                (MolalityUnit.MolePerKilogram, MolalityUnit.MillimolePerKilogram) => new Molality(_value * 1000, MolalityUnit.MillimolePerKilogram),
                (MolalityUnit.MolePerKilogram, MolalityUnit.MolePerGram) => new Molality(_value / 1000, MolalityUnit.MolePerGram),
