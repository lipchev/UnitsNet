...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        public QuantityValue As(RotationalSpeedUnit unit)
        {
            if (Unit == unit)
                return Value;
        ...
        private bool TryToUnit(RotationalSpeedUnit unit, [NotNullWhen(true)] out RotationalSpeed? converted)
        {
            ...
            RotationalSpeed? convertedOrNull = (Unit, unit) switch
            {
                ...
                (RotationalSpeedUnit.CentiradianPerSecond, RotationalSpeedUnit.RadianPerSecond) => new RotationalSpeed(_value / 100, RotationalSpeedUnit.RadianPerSecond),
                (RotationalSpeedUnit.DeciradianPerSecond, RotationalSpeedUnit.RadianPerSecond) => new RotationalSpeed(_value / 10, RotationalSpeedUnit.RadianPerSecond),
                (RotationalSpeedUnit.DegreePerMinute, RotationalSpeedUnit.RadianPerSecond) => new RotationalSpeed(_value * new QuantityValue(3141592653589793, 108) / BigInteger.Pow(10, 17), RotationalSpeedUnit.RadianPerSecond),
                (RotationalSpeedUnit.DegreePerSecond, RotationalSpeedUnit.RadianPerSecond) => new RotationalSpeed(_value * new QuantityValue(3141592653589793, 180000000000000000), RotationalSpeedUnit.RadianPerSecond),
                (RotationalSpeedUnit.MicrodegreePerSecond, RotationalSpeedUnit.RadianPerSecond) => new RotationalSpeed(_value * new QuantityValue(3141592653589793, 18) / BigInteger.Pow(10, 22), RotationalSpeedUnit.RadianPerSecond),
                (RotationalSpeedUnit.MicroradianPerSecond, RotationalSpeedUnit.RadianPerSecond) => new RotationalSpeed(_value / 1000000, RotationalSpeedUnit.RadianPerSecond),
                (RotationalSpeedUnit.MillidegreePerSecond, RotationalSpeedUnit.RadianPerSecond) => new RotationalSpeed(_value * new QuantityValue(3141592653589793, 18) / BigInteger.Pow(10, 19), RotationalSpeedUnit.RadianPerSecond),
                (RotationalSpeedUnit.MilliradianPerSecond, RotationalSpeedUnit.RadianPerSecond) => new RotationalSpeed(_value / 1000, RotationalSpeedUnit.RadianPerSecond),
                (RotationalSpeedUnit.NanodegreePerSecond, RotationalSpeedUnit.RadianPerSecond) => new RotationalSpeed(_value * new QuantityValue(3141592653589793, 18) / BigInteger.Pow(10, 25), RotationalSpeedUnit.RadianPerSecond),
                (RotationalSpeedUnit.NanoradianPerSecond, RotationalSpeedUnit.RadianPerSecond) => new RotationalSpeed(_value / 1000000000, RotationalSpeedUnit.RadianPerSecond),
                (RotationalSpeedUnit.RevolutionPerMinute, RotationalSpeedUnit.RadianPerSecond) => new RotationalSpeed(_value * new QuantityValue(3141592653589793, 30000000000000000), RotationalSpeedUnit.RadianPerSecond),
                (RotationalSpeedUnit.RevolutionPerSecond, RotationalSpeedUnit.RadianPerSecond) => new RotationalSpeed(_value * new QuantityValue(3141592653589793, 500000000000000), RotationalSpeedUnit.RadianPerSecond),

                // BaseUnit -> RotationalSpeedUnit
                (RotationalSpeedUnit.RadianPerSecond, RotationalSpeedUnit.CentiradianPerSecond) => new RotationalSpeed(_value * 100, RotationalSpeedUnit.CentiradianPerSecond),
                (RotationalSpeedUnit.RadianPerSecond, RotationalSpeedUnit.DeciradianPerSecond) => new RotationalSpeed(_value * 10, RotationalSpeedUnit.DeciradianPerSecond),
                (RotationalSpeedUnit.RadianPerSecond, RotationalSpeedUnit.DegreePerMinute) => new RotationalSpeed(_value * new QuantityValue(108, 3141592653589793) * BigInteger.Pow(10, 17), RotationalSpeedUnit.DegreePerMinute),
                (RotationalSpeedUnit.RadianPerSecond, RotationalSpeedUnit.DegreePerSecond) => new RotationalSpeed(_value * new QuantityValue(180000000000000000, 3141592653589793), RotationalSpeedUnit.DegreePerSecond),
                (RotationalSpeedUnit.RadianPerSecond, RotationalSpeedUnit.MicrodegreePerSecond) => new RotationalSpeed(_value * new QuantityValue(18, 3141592653589793) * BigInteger.Pow(10, 22), RotationalSpeedUnit.MicrodegreePerSecond),
                (RotationalSpeedUnit.RadianPerSecond, RotationalSpeedUnit.MicroradianPerSecond) => new RotationalSpeed(_value * 1000000, RotationalSpeedUnit.MicroradianPerSecond),
                (RotationalSpeedUnit.RadianPerSecond, RotationalSpeedUnit.MillidegreePerSecond) => new RotationalSpeed(_value * new QuantityValue(18, 3141592653589793) * BigInteger.Pow(10, 19), RotationalSpeedUnit.MillidegreePerSecond),
                (RotationalSpeedUnit.RadianPerSecond, RotationalSpeedUnit.MilliradianPerSecond) => new RotationalSpeed(_value * 1000, RotationalSpeedUnit.MilliradianPerSecond),
                (RotationalSpeedUnit.RadianPerSecond, RotationalSpeedUnit.NanodegreePerSecond) => new RotationalSpeed(_value * new QuantityValue(18, 3141592653589793) * BigInteger.Pow(10, 25), RotationalSpeedUnit.NanodegreePerSecond),
                (RotationalSpeedUnit.RadianPerSecond, RotationalSpeedUnit.NanoradianPerSecond) => new RotationalSpeed(_value * 1000000000, RotationalSpeedUnit.NanoradianPerSecond),
                (RotationalSpeedUnit.RadianPerSecond, RotationalSpeedUnit.RevolutionPerMinute) => new RotationalSpeed(_value * new QuantityValue(30000000000000000, 3141592653589793), RotationalSpeedUnit.RevolutionPerMinute),
                (RotationalSpeedUnit.RadianPerSecond, RotationalSpeedUnit.RevolutionPerSecond) => new RotationalSpeed(_value * new QuantityValue(500000000000000, 3141592653589793), RotationalSpeedUnit.RevolutionPerSecond),
