...
namespace UnitsNet
{
    ...
    public partial struct MolarEnergy : IQuantity<MolarEnergyUnit>, IEquatable<MolarEnergy>, IComparable, IComparable<MolarEnergy>, IConvertible, IFormattable
    {
        ...
        public MolarEnergy(double value, UnitSystem unitSystem)
        {
            ...
            var defaultUnitInfo = unitSystem.GetDefaultUnitInfo(QuantityType) as UnitInfo<MolarEnergyUnit>;
        ...
        /// <exception cref="ArgumentNullException">The value of 'str' cannot be null. </exception>
        /// <exception cref="UnitsNetException">Error parsing string.</exception>
        public static MolarEnergyUnit ParseUnit(string str, [CanBeNull] IFormatProvider provider)
        {
        ...
        {
            return QuantityFormatter.Format<MolarEnergyUnit>(this, format, formatProvider);
        }
