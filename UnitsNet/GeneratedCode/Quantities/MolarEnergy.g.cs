        ...
        IFormattable
    {
        ...
        private bool TryToUnit(MolarEnergyUnit unit, [NotNullWhen(true)] out MolarEnergy? converted)
        {
            ...
            MolarEnergy? convertedOrNull = (Unit, unit) switch
            {
                ...
                (MolarEnergyUnit.KilojoulePerMole, MolarEnergyUnit.JoulePerMole) => new MolarEnergy(_value * 1000, MolarEnergyUnit.JoulePerMole),
                (MolarEnergyUnit.MegajoulePerMole, MolarEnergyUnit.JoulePerMole) => new MolarEnergy(_value * 1000000, MolarEnergyUnit.JoulePerMole),

                // BaseUnit -> MolarEnergyUnit
                (MolarEnergyUnit.JoulePerMole, MolarEnergyUnit.KilojoulePerMole) => new MolarEnergy(_value / 1000, MolarEnergyUnit.KilojoulePerMole),
                (MolarEnergyUnit.JoulePerMole, MolarEnergyUnit.MegajoulePerMole) => new MolarEnergy(_value / 1000000, MolarEnergyUnit.MegajoulePerMole),
