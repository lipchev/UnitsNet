        ...
        IFormattable
    {
        ...
        private bool TryToUnit(AmplitudeRatioUnit unit, [NotNullWhen(true)] out AmplitudeRatio? converted)
        {
            ...
            AmplitudeRatio? convertedOrNull = (Unit, unit) switch
            {
                ...
                (AmplitudeRatioUnit.DecibelUnloaded, AmplitudeRatioUnit.DecibelVolt) => new AmplitudeRatio(_value + new QuantityValue(-2218487499, 1000000000), AmplitudeRatioUnit.DecibelVolt),
                ...
                (AmplitudeRatioUnit.DecibelVolt, AmplitudeRatioUnit.DecibelUnloaded) => new AmplitudeRatio(_value + new QuantityValue(2218487499, 1000000000), AmplitudeRatioUnit.DecibelUnloaded),
