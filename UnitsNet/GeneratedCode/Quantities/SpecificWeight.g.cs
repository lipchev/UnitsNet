        ...
        IFormattable
    {
        ...
        private bool TryToUnit(SpecificWeightUnit unit, [NotNullWhen(true)] out SpecificWeight? converted)
        {
            ...
            SpecificWeight? convertedOrNull = (Unit, unit) switch
            {
                ...
                (SpecificWeightUnit.KilogramForcePerCubicMeter, SpecificWeightUnit.NewtonPerCubicMeter) => new SpecificWeight(_value * new QuantityValue(196133, 20000), SpecificWeightUnit.NewtonPerCubicMeter),
                ...
                (SpecificWeightUnit.KilopoundForcePerCubicFoot, SpecificWeightUnit.NewtonPerCubicMeter) => new SpecificWeight(_value * new QuantityValue(1112055403815125, 7079211648), SpecificWeightUnit.NewtonPerCubicMeter),
                (SpecificWeightUnit.KilopoundForcePerCubicInch, SpecificWeightUnit.NewtonPerCubicMeter) => new SpecificWeight(_value * new QuantityValue(1112055403815125, 4096766), SpecificWeightUnit.NewtonPerCubicMeter),
                ...
                (SpecificWeightUnit.PoundForcePerCubicFoot, SpecificWeightUnit.NewtonPerCubicMeter) => new SpecificWeight(_value * new QuantityValue(8896443230521, 56633693184), SpecificWeightUnit.NewtonPerCubicMeter),
                (SpecificWeightUnit.PoundForcePerCubicInch, SpecificWeightUnit.NewtonPerCubicMeter) => new SpecificWeight(_value * new QuantityValue(8896443230521, 32774128), SpecificWeightUnit.NewtonPerCubicMeter),
                ...
                (SpecificWeightUnit.TonneForcePerCubicMeter, SpecificWeightUnit.NewtonPerCubicMeter) => new SpecificWeight(_value * new QuantityValue(196133, 20), SpecificWeightUnit.NewtonPerCubicMeter),
                ...
                (SpecificWeightUnit.NewtonPerCubicMeter, SpecificWeightUnit.KilogramForcePerCubicMeter) => new SpecificWeight(_value * new QuantityValue(20000, 196133), SpecificWeightUnit.KilogramForcePerCubicMeter),
                ...
                (SpecificWeightUnit.NewtonPerCubicMeter, SpecificWeightUnit.KilopoundForcePerCubicFoot) => new SpecificWeight(_value * new QuantityValue(7079211648, 1112055403815125), SpecificWeightUnit.KilopoundForcePerCubicFoot),
                (SpecificWeightUnit.NewtonPerCubicMeter, SpecificWeightUnit.KilopoundForcePerCubicInch) => new SpecificWeight(_value * new QuantityValue(4096766, 1112055403815125), SpecificWeightUnit.KilopoundForcePerCubicInch),
                ...
                (SpecificWeightUnit.NewtonPerCubicMeter, SpecificWeightUnit.PoundForcePerCubicFoot) => new SpecificWeight(_value * new QuantityValue(56633693184, 8896443230521), SpecificWeightUnit.PoundForcePerCubicFoot),
                (SpecificWeightUnit.NewtonPerCubicMeter, SpecificWeightUnit.PoundForcePerCubicInch) => new SpecificWeight(_value * new QuantityValue(32774128, 8896443230521), SpecificWeightUnit.PoundForcePerCubicInch),
                ...
                (SpecificWeightUnit.NewtonPerCubicMeter, SpecificWeightUnit.TonneForcePerCubicMeter) => new SpecificWeight(_value * new QuantityValue(20, 196133), SpecificWeightUnit.TonneForcePerCubicMeter),
