...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        public VitaminA(QuantityValue value, UnitSystem unitSystem)
        {
        ...
        /// </summary>
        public QuantityValue InternationalUnits => As(VitaminAUnit.InternationalUnit);
        ...
        public QuantityValue As(VitaminAUnit unit)
        {
            if (Unit == unit)
                return Value;
