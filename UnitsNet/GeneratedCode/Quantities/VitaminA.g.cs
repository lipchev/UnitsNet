...
namespace UnitsNet
{
    ...
    public partial struct VitaminA : IQuantity<VitaminAUnit>, IEquatable<VitaminA>, IComparable, IComparable<VitaminA>, IConvertible, IFormattable
    {
        ...
        public VitaminA(double value, UnitSystem unitSystem)
        {
            ...
            var defaultUnitInfo = unitSystem.GetDefaultUnitInfo(QuantityType) as UnitInfo<VitaminAUnit>;
        ...
        /// <exception cref="ArgumentNullException">The value of 'str' cannot be null. </exception>
        /// <exception cref="UnitsNetException">Error parsing string.</exception>
        public static VitaminAUnit ParseUnit(string str, [CanBeNull] IFormatProvider provider)
        {
        ...
        {
            return QuantityFormatter.Format<VitaminAUnit>(this, format, formatProvider);
        }
