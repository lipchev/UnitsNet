        ...
        IFormattable
    {
        ...
        private bool TryToUnit(TemperatureGradientUnit unit, [NotNullWhen(true)] out TemperatureGradient? converted)
        {
            ...
            TemperatureGradient? convertedOrNull = (Unit, unit) switch
            {
                ...
                (TemperatureGradientUnit.DegreeFahrenheitPerFoot, TemperatureGradientUnit.KelvinPerMeter) => new TemperatureGradient(_value * new QuantityValue(6250, 3429), TemperatureGradientUnit.KelvinPerMeter),
                ...
                (TemperatureGradientUnit.KelvinPerMeter, TemperatureGradientUnit.DegreeFahrenheitPerFoot) => new TemperatureGradient(_value * new QuantityValue(3429, 6250), TemperatureGradientUnit.DegreeFahrenheitPerFoot),
