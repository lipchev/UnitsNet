        ...
        IFormattable
    {
        ...
        private bool TryToUnit(VolumeFlowPerAreaUnit unit, [NotNullWhen(true)] out VolumeFlowPerArea? converted)
        {
            ...
            VolumeFlowPerArea? convertedOrNull = (Unit, unit) switch
            {
                ...
                (VolumeFlowPerAreaUnit.CubicFootPerMinutePerSquareFoot, VolumeFlowPerAreaUnit.CubicMeterPerSecondPerSquareMeter) => new VolumeFlowPerArea(_value * new QuantityValue(127, 25000), VolumeFlowPerAreaUnit.CubicMeterPerSecondPerSquareMeter),

                // BaseUnit -> VolumeFlowPerAreaUnit
                (VolumeFlowPerAreaUnit.CubicMeterPerSecondPerSquareMeter, VolumeFlowPerAreaUnit.CubicFootPerMinutePerSquareFoot) => new VolumeFlowPerArea(_value * new QuantityValue(25000, 127), VolumeFlowPerAreaUnit.CubicFootPerMinutePerSquareFoot),
