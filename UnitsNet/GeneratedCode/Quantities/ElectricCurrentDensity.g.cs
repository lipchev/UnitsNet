...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        /// </summary>
        public QuantityValue AmperesPerSquareFoot => As(ElectricCurrentDensityUnit.AmperePerSquareFoot);

        /// <summary>
        ///     Gets a <see cref="double"/> value of this quantity converted into <see cref="ElectricCurrentDensityUnit.AmperePerSquareInch"/>
        /// </summary>
        public QuantityValue AmperesPerSquareInch => As(ElectricCurrentDensityUnit.AmperePerSquareInch);

        /// <summary>
        ///     Gets a <see cref="double"/> value of this quantity converted into <see cref="ElectricCurrentDensityUnit.AmperePerSquareMeter"/>
        /// </summary>
        public QuantityValue AmperesPerSquareMeter => As(ElectricCurrentDensityUnit.AmperePerSquareMeter);
        ...
        public QuantityValue As(ElectricCurrentDensityUnit unit)
        {
            if (Unit == unit)
                return Value;
        ...
        private bool TryToUnit(ElectricCurrentDensityUnit unit, [NotNullWhen(true)] out ElectricCurrentDensity? converted)
        {
            ...
            ElectricCurrentDensity? convertedOrNull = (Unit, unit) switch
            {
                ...
                (ElectricCurrentDensityUnit.AmperePerSquareFoot, ElectricCurrentDensityUnit.AmperePerSquareMeter) => new ElectricCurrentDensity(_value * new QuantityValue(1562500, 145161), ElectricCurrentDensityUnit.AmperePerSquareMeter),
                (ElectricCurrentDensityUnit.AmperePerSquareInch, ElectricCurrentDensityUnit.AmperePerSquareMeter) => new ElectricCurrentDensity(_value * new QuantityValue(25000000, 16129), ElectricCurrentDensityUnit.AmperePerSquareMeter),

                // BaseUnit -> ElectricCurrentDensityUnit
                (ElectricCurrentDensityUnit.AmperePerSquareMeter, ElectricCurrentDensityUnit.AmperePerSquareFoot) => new ElectricCurrentDensity(_value * new QuantityValue(145161, 1562500), ElectricCurrentDensityUnit.AmperePerSquareFoot),
                (ElectricCurrentDensityUnit.AmperePerSquareMeter, ElectricCurrentDensityUnit.AmperePerSquareInch) => new ElectricCurrentDensity(_value * new QuantityValue(16129, 25000000), ElectricCurrentDensityUnit.AmperePerSquareInch),
