        ...
        IFormattable
    {
        ...
        private bool TryToUnit(StandardVolumeFlowUnit unit, [NotNullWhen(true)] out StandardVolumeFlow? converted)
        {
            ...
            StandardVolumeFlow? convertedOrNull = (Unit, unit) switch
            {
                ...
                (StandardVolumeFlowUnit.StandardCubicFootPerHour, StandardVolumeFlowUnit.StandardCubicMeterPerSecond) => new StandardVolumeFlow(_value * new QuantityValue(6145149, 781250000000), StandardVolumeFlowUnit.StandardCubicMeterPerSecond),
                (StandardVolumeFlowUnit.StandardCubicFootPerMinute, StandardVolumeFlowUnit.StandardCubicMeterPerSecond) => new StandardVolumeFlow(_value * new QuantityValue(18435447, 39062500000), StandardVolumeFlowUnit.StandardCubicMeterPerSecond),
                (StandardVolumeFlowUnit.StandardCubicFootPerSecond, StandardVolumeFlowUnit.StandardCubicMeterPerSecond) => new StandardVolumeFlow(_value * new QuantityValue(55306341, 1953125000), StandardVolumeFlowUnit.StandardCubicMeterPerSecond),
                ...
                (StandardVolumeFlowUnit.StandardCubicMeterPerSecond, StandardVolumeFlowUnit.StandardCubicFootPerHour) => new StandardVolumeFlow(_value * new QuantityValue(781250000000, 6145149), StandardVolumeFlowUnit.StandardCubicFootPerHour),
                (StandardVolumeFlowUnit.StandardCubicMeterPerSecond, StandardVolumeFlowUnit.StandardCubicFootPerMinute) => new StandardVolumeFlow(_value * new QuantityValue(39062500000, 18435447), StandardVolumeFlowUnit.StandardCubicFootPerMinute),
                (StandardVolumeFlowUnit.StandardCubicMeterPerSecond, StandardVolumeFlowUnit.StandardCubicFootPerSecond) => new StandardVolumeFlow(_value * new QuantityValue(1953125000, 55306341), StandardVolumeFlowUnit.StandardCubicFootPerSecond),
