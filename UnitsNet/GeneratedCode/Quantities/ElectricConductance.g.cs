...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        public QuantityValue As(ElectricConductanceUnit unit)
        {
            if (Unit == unit)
                return Value;
