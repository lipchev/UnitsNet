...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        public QuantityValue As(DynamicViscosityUnit unit)
        {
            if (Unit == unit)
                return Value;
        ...
        private bool TryToUnit(DynamicViscosityUnit unit, [NotNullWhen(true)] out DynamicViscosity? converted)
        {
            ...
            DynamicViscosity? convertedOrNull = (Unit, unit) switch
            {
                ...
                (DynamicViscosityUnit.Centipoise, DynamicViscosityUnit.NewtonSecondPerMeterSquared) => new DynamicViscosity(_value / 1000, DynamicViscosityUnit.NewtonSecondPerMeterSquared),
                (DynamicViscosityUnit.MicropascalSecond, DynamicViscosityUnit.NewtonSecondPerMeterSquared) => new DynamicViscosity(_value / 1000000, DynamicViscosityUnit.NewtonSecondPerMeterSquared),
                (DynamicViscosityUnit.MillipascalSecond, DynamicViscosityUnit.NewtonSecondPerMeterSquared) => new DynamicViscosity(_value / 1000, DynamicViscosityUnit.NewtonSecondPerMeterSquared),
                ...
                (DynamicViscosityUnit.PoundForceSecondPerSquareFoot, DynamicViscosityUnit.NewtonSecondPerMeterSquared) => new DynamicViscosity(_value * new QuantityValue(8896443230521, 185806080000), DynamicViscosityUnit.NewtonSecondPerMeterSquared),
                (DynamicViscosityUnit.PoundForceSecondPerSquareInch, DynamicViscosityUnit.NewtonSecondPerMeterSquared) => new DynamicViscosity(_value * new QuantityValue(8896443230521, 1290320000), DynamicViscosityUnit.NewtonSecondPerMeterSquared),
                (DynamicViscosityUnit.PoundPerFootSecond, DynamicViscosityUnit.NewtonSecondPerMeterSquared) => new DynamicViscosity(_value * new QuantityValue(45359237, 30480000), DynamicViscosityUnit.NewtonSecondPerMeterSquared),
                (DynamicViscosityUnit.Reyn, DynamicViscosityUnit.NewtonSecondPerMeterSquared) => new DynamicViscosity(_value * new QuantityValue(8896443230521, 1290320000), DynamicViscosityUnit.NewtonSecondPerMeterSquared),

                // BaseUnit -> DynamicViscosityUnit
                (DynamicViscosityUnit.NewtonSecondPerMeterSquared, DynamicViscosityUnit.Centipoise) => new DynamicViscosity(_value * 1000, DynamicViscosityUnit.Centipoise),
                (DynamicViscosityUnit.NewtonSecondPerMeterSquared, DynamicViscosityUnit.MicropascalSecond) => new DynamicViscosity(_value * 1000000, DynamicViscosityUnit.MicropascalSecond),
                (DynamicViscosityUnit.NewtonSecondPerMeterSquared, DynamicViscosityUnit.MillipascalSecond) => new DynamicViscosity(_value * 1000, DynamicViscosityUnit.MillipascalSecond),
                ...
                (DynamicViscosityUnit.NewtonSecondPerMeterSquared, DynamicViscosityUnit.PoundForceSecondPerSquareFoot) => new DynamicViscosity(_value * new QuantityValue(185806080000, 8896443230521), DynamicViscosityUnit.PoundForceSecondPerSquareFoot),
                (DynamicViscosityUnit.NewtonSecondPerMeterSquared, DynamicViscosityUnit.PoundForceSecondPerSquareInch) => new DynamicViscosity(_value * new QuantityValue(1290320000, 8896443230521), DynamicViscosityUnit.PoundForceSecondPerSquareInch),
                (DynamicViscosityUnit.NewtonSecondPerMeterSquared, DynamicViscosityUnit.PoundPerFootSecond) => new DynamicViscosity(_value * new QuantityValue(30480000, 45359237), DynamicViscosityUnit.PoundPerFootSecond),
                (DynamicViscosityUnit.NewtonSecondPerMeterSquared, DynamicViscosityUnit.Reyn) => new DynamicViscosity(_value * new QuantityValue(1290320000, 8896443230521), DynamicViscosityUnit.Reyn),
