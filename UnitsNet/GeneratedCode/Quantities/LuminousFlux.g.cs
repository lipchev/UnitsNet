...
namespace UnitsNet
{
    ...
    public partial struct LuminousFlux : IQuantity<LuminousFluxUnit>, IEquatable<LuminousFlux>, IComparable, IComparable<LuminousFlux>, IConvertible, IFormattable
    {
        ...
        public LuminousFlux(double value, UnitSystem unitSystem)
        {
            ...
            var defaultUnitInfo = unitSystem.GetDefaultUnitInfo(QuantityType) as UnitInfo<LuminousFluxUnit>;
        ...
        /// <exception cref="ArgumentNullException">The value of 'str' cannot be null. </exception>
        /// <exception cref="UnitsNetException">Error parsing string.</exception>
        public static LuminousFluxUnit ParseUnit(string str, [CanBeNull] IFormatProvider provider)
        {
        ...
        {
            return QuantityFormatter.Format<LuminousFluxUnit>(this, format, formatProvider);
        }
