...
/// </summary>
/// <remarks>
///     This class inherits from the <see cref="System.ComponentModel.TypeConverter" /> class and provides methods to
///     convert
...
public class QuantityValueTypeConverter : TypeConverter
{
    ...
    public override bool CanConvertTo(ITypeDescriptorContext? context, Type? destinationType)
    {
        return destinationType switch
        {
            ...
            _ when destinationType == typeof(Fraction) => true,
    ...
    public override bool CanConvertFrom(ITypeDescriptorContext? context, Type sourceType)
    {
        return sourceType switch
        {
            ...
            _ when sourceType == typeof(Fraction) => true,
    ...
    public override object? ConvertTo(ITypeDescriptorContext? context, CultureInfo? culture, object? value, Type destinationType)
    {
        if (value is QuantityValue quantityValue)
        {
            return destinationType switch
            {
                ...
                _ when destinationType == typeof(Fraction) => Fraction(),
    ...
    public override object? ConvertFrom(ITypeDescriptorContext? context, CultureInfo? culture, object? value)
    {
        ...
        return value switch
        {
            ...
            int i => new QuantityValue(i, 1),
            long l => new QuantityValue(l, 1),
            decimal d => QuantityValue.FromDecimal(d),
            double dbl => QuantityValue.FromDoubleRounded(dbl),
            Fraction fraction => new QuantityValue(fraction.Numerator, fraction.Denominator),
            BigInteger bigInteger => new QuantityValue(bigInteger, 1),
